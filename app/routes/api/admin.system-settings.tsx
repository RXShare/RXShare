...
export async function action({ request }: { request: Request }) {
  ...
  const allowed = ["site_name", "site_description", "base_url", "allow_registration", "allow_login", "allow_email", "default_quota", "max_upload_size", "primary_color", "accent_color", "dashboard_layout", "logo_url", "background_pattern", "captcha_provider", "captcha_site_key", "captcha_secret_key", "captcha_on_login", "captcha_on_signup", "captcha_on_upload", "show_powered_by", "user_controlled_layout", "default_invite_quota", "resend_api_key", "email_from"];
