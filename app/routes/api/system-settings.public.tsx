...
export async function loader() {
  try {
    ...
    return Response.json(settings || { site_name: "XShare", allow_registration: 1, allow_login: 1 });
  } catch {
    return Response.json({ site_name: "XShare", allow_registration: 1, allow_login: 1 });
  }
}
