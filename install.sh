...
echo ""
echo "  After setup, configure CAPTCHA protection"
echo "  in Admin Panel → Security to protect"
echo "  login, signup, and upload forms."
echo "  Supports reCAPTCHA, Turnstile, and hCaptcha."
echo ""
